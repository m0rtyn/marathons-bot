...
export const MESSAGES = {
  ...
  UNKNOWN_TEXT: "Извините, я не понимаю вас 😰 Попробуйте использовать кнопки ответа вместо текста.\nА ещё вы можете спосить о помощи у @m0rtyn.", // "Sorry, I don't understand you. Try to use answer buttons instead of typing text. Also you can ask @m0rtyn for help about me.",
